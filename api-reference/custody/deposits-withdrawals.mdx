...
description: "REST endpoints for depositing and withdrawing crypto and fiat on Bullish Exchange — retrieve deposit addresses, set withdrawal instructions, and submit withdrawals."
---
