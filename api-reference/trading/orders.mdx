---
title: "Order Management API Endpoints — Create, Query, and Cancel Orders"
sidebarTitle: "Orders"
description: "REST endpoints for managing orders on Bullish Exchange — create limit/market orders, query open and historical orders, cancel and amend via command entry."
---
...
| `BX-PUBLIC-KEY` | The public key used to generate the JWT. |
...
- `setMMPCommandV1` — Configure MMP parameters for an underlying asset symbol.
- `resetMMPCommandV1` — Reset MMP configuration for an underlying asset symbol.
