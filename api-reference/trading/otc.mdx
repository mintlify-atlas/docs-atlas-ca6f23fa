---
title: "OTC Trade Endpoints — Create, Query, and Cancel OTC Trades"
sidebarTitle: "OTC"
description: "REST endpoints for OTC trades on Bullish Exchange — create, query, and cancel over-the-counter bilateral trades using bearer JWT auth."
---
