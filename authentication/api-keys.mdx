---
title: "Generate and Manage Bullish Exchange API Keys"
sidebarTitle: "API Keys"
description: "How to create ECDSA and HMAC API keys in the Bullish web interface — key types, security best practices, and metadata decoding."
---
